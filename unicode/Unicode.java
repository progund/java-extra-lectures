public class Unicode {
  public static void main(String[] args) {
    ...
    System.out.println(bomb + " .length(): " + bomb.length());
    System.out.println("First part:  " + Integer.toHexString(bomb.charAt(0)));
    System.out.println("Second part: " + Integer.toHexString(bomb.charAt(1)));
    ...
    c = 0x1F4A9;
    System.out.println(turd + " has int value " + c);
